...
# distance_diff=[x_dist_tot[6]-x_dist_stat[0],x_dist_tot[8]-x_dist_stat[1],x_dist_tot[10]-x_dist_stat[2],x_dist_tot[14]-x_dist_stat[3],x_dist_tot[17]-x_dist_stat[4],x_dist_tot[21]-x_dist_stat[5],x_dist_tot[25]-x_dist_stat[6],x_dist_tot[29]-x_dist_stat[7],x_dist_tot[33]-x_dist_stat[8],x_dist_tot[37]-x_dist_stat[9],x_dist_tot[39]-x_dist_stat[10],x_dist_tot[41]-x_dist_stat[11]]
# print(distance_diff)
...
#     #Indent from here
        ...
        p_inf=get_ambient_results_new(row_number_adjusted)[3]
        ...
        velocity_rake=[]
        free_stream_rake=[]
        p_dyn_small=[p_tot[6]-p_stat[0],p_tot[8]-p_stat[1],p_tot[10]-p_stat[2],p_tot[14]-p_stat[3],p_tot[17]-p_stat[4],p_tot[21]-p_stat[5],p_tot[25]-p_stat[6],p_tot[29]-p_stat[7],p_tot[33]-p_stat[8],p_tot[37]-p_stat[9],p_tot[39]-p_stat[10],p_tot[41]-p_stat[11]]
        p_tot_small=[p_tot[6],p_tot[8],p_tot[10],p_tot[14],p_tot[17],p_tot[21],p_tot[25],p_tot[29],p_tot[33],p_tot[37],p_tot[39],p_tot[41]]
        # print(p_dyn_small)
        ...
        # print(D)
        # print(C_d)
        # drag_coef_bad.append(C_d)


        D_2= abs(density*np.trapz(Integrand_3,x=y_dist_stat,axis=0) + np.trapz(Integrand_2,x=y_dist_stat,axis=0))
        C_d2= (D_2/(q_inf*0.16))
        ...
        # plt.plot(x_dist_stat,p_dyn_small)
        # plt.show()
...
# plt.plot(x_dist_tot,velocity,marker=".",linewidth=0.5)
...
# plt.legend(("Computed Velocity from wake", "Computed Free Stream velocity at this AoA"))
...
#plot the Cd Alpha graph

plt.plot(Angle,drag_coef,marker="x",linewidth=0.5)
#plt.plot(Angle,drag_coef_bad)
plt.ylim(bottom=0)
plt.grid()

plt.xlabel('Angle of Attack [deg]')
plt.ylabel(r'$C_d$ [-]')
plt.legend(["Computed Drag Coefficient"])
