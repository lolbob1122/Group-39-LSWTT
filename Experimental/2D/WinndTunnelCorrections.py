...
def get_corrected_CdClCmalpha_lst(T_infty, Cd_u, Cl_u, Cm_u, alpha_u, q_infty, rho):
    ...
    # plt.subplot(1, 2, 1)
    # plt.plot(alpha_c_lst, Es_lst, color='purple', linestyle='-', linewidth=1, markeredgewidth=0.5, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', label='$\\epsilon_s$')
    # plt.plot(alpha_c_lst, Ew_lst, color='green', linestyle='-', linewidth=1, markeredgewidth=0.5,marker='+', markerfacecolor='none', markersize=5, markeredgecolor='green',label='$\\epsilon_w$')
    # plt.plot(alpha_c_lst, Esep_lst, color='blue', linestyle='-', linewidth=1, markeredgewidth=0.5,marker='v', markerfacecolor='none', markersize=5, markeredgecolor='blue',label='$\\epsilon_{sep}$')
    # plt.plot(alpha_c_lst, Et_lst, color='red', linewidth=1, markeredgewidth=0.5,marker='D',markerfacecolor='none', markersize=5, markeredgecolor='red',label='$\\epsilon_t$')
    ...
    # plt.plot(alpha_c_lst, Et_lst, color='red', linewidth=1, markeredgewidth=0.5, marker='D',markerfacecolor='none', markersize=5, markeredgecolor='red',label='$\\epsilon_t$')
    # plt.xlabel("$\\alpha_c$ [$\\deg$]")
    # plt.ylabel("Total interference factor $\\epsilon_t$ [-]")
    # plt.ylim(-0.03, 0.04)
    # plt.grid(True)
    # plt.legend()
    ...
    plt.plot(alpha_u, q_inf_ratio_lst, color='red', linewidth=1, markeredgewidth=0.5, linestyle='-', marker='x', markerfacecolor='none', markersize=5, markeredgecolor='red', label='$\\frac{q_{\\infty_u}}{q_{\\infty_c}}$')
    plt.xlabel("$\\alpha$ [$\\deg$]", fontsize=12)
    plt.ylabel("Ratio's of uncorrected to corrected flow properties", fontsize=12)
    plt.grid(True)
    ...
    plt.plot(alpha_c_lst, Cl_c_lst, color='red', linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='red', markeredgewidth=0.5, label='$C_{l_c}$') 
    plt.plot(alpha_u, Cl_u, color='blue', linewidth=1, marker='+', markerfacecolor='none', markersize=5, markeredgecolor='blue', markeredgewidth=0.5, label='$C_{l_u}$')
    plt.xlabel("$\\alpha$ [$\\deg$]", fontsize=12)
    ...
    plt.plot(alpha_c_lst, Cd_c_lst, color='red', linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='red', markeredgewidth=0.5,label='$C_{d_c}$')
    plt.plot(alpha_u, Cd_u, color='blue', linewidth=1, marker='+', markerfacecolor='none', markersize=5, markeredgecolor='blue', markeredgewidth=0.5,label='$C_{d_u}$')
    plt.xlabel("$\\alpha$ [$\\deg$]", fontsize=12)
    ...
    plt.plot(Cd_c_lst, Cl_c_lst, color='red', linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='red', markeredgewidth=0.5,label='Corrected')
    plt.plot(Cd_u, Cl_u, color='blue', linewidth=1, marker='+', markerfacecolor='none', markersize=5, markeredgecolor='blue', markeredgewidth=0.5,label='Uncorrected')
    ...
    plt.plot(alpha_c_lst, Cm_c_lst, color='red', linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='red', markeredgewidth=0.5,label='$C_{m_c}$')
    plt.plot(alpha_u, Cm_u, color='blue', linewidth=1, marker='+', markerfacecolor='none', markersize=5, markeredgecolor='blue', markeredgewidth=0.5,label='$C_{m_u}$')
    plt.xlabel("$\\alpha$ [$\\deg$]", fontsize=12)
