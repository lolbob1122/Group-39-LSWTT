...
plt.plot(alpha_real_lst[:37], CL_real_lst[:37], color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5, label='XFLR5 Results')
plt.plot(alpha_real_lst[36:52], CL_real_lst[36:52], markevery=slice(2, None, 5),color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5)
plt.plot(alpha_real_lst[51:], CL_real_lst[51:], color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5)
plt.plot(alpha_lst, CL_lst, color='green', linewidth=1, marker='v', markerfacecolor='none', markersize=5, markeredgecolor='green', markeredgewidth=0.5,label='Wind Tunnel Results')
...
plt.plot(alpha_real_lst[:37], CD_real_lst[:37], color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5, label='XFLR5 Results')
plt.plot(alpha_real_lst[36:52], CD_real_lst[36:52], markevery=slice(2, None, 5),color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5)
plt.plot(alpha_real_lst[51:], CD_real_lst[51:], color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5)
plt.xlabel("$\\alpha$ [$\\deg$]", fontsize=12)
...
plt.plot(CL_real_lst[:37], CD_real_lst[:37], color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5, label='XFLR5 Results')
plt.plot(CL_real_lst[36:52], CD_real_lst[36:52], markevery=slice(2, None, 5),color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5)
plt.plot(CL_real_lst[51:], CD_real_lst[51:], color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5)
...
plt.plot(alpha_real_lst[:37], CDi_real_lst[:37], color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5, label='XFLR5 Results')
plt.plot(alpha_real_lst[36:52], CDi_real_lst[36:52], markevery=slice(2, None, 5),color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5)
plt.plot(alpha_real_lst[51:], CDi_real_lst[51:], color='purple',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5)
plt.xlabel("$\\alpha$ [$\\deg$]", fontsize=12)
plt.ylabel("$C_{D_i}$ [-]", fontsize=12)
plt.grid(True)
plt.legend(fontsize=12)
...
plt.plot(alpha_real_lst[:37], CDv_real_lst[:37], color='green',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='green', markeredgewidth=0.5, label='$C_{D_0}$')
plt.plot(alpha_real_lst[:37], CD_real_lst[:37], color='purple', linewidth=1, marker='v', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5,label='$C_D$')
plt.plot(alpha_real_lst[:37], CDi_real_lst[:37], color='blue', linewidth=1, marker='+', markerfacecolor='none', markersize=5, markeredgecolor='blue', markeredgewidth=0.5,label='$C_{D_i}$')
plt.plot(alpha_real_lst[36:52], CDv_real_lst[36:52], color='green',markevery=slice(2, None, 5),linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='green', markeredgewidth=0.5)
plt.plot(alpha_real_lst[36:52], CD_real_lst[36:52], color='purple', markevery=slice(2, None, 5),linewidth=1, marker='v', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5)
plt.plot(alpha_real_lst[36:52], CDi_real_lst[36:52], color='blue', markevery=slice(2, None, 5),linewidth=1, marker='+', markerfacecolor='none', markersize=5, markeredgecolor='blue', markeredgewidth=0.5)
plt.plot(alpha_real_lst[51:], CDv_real_lst[51:], color='green',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='green', markeredgewidth=0.5)
plt.plot(alpha_real_lst[51:], CD_real_lst[51:], color='purple', linewidth=1, marker='v', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5)
plt.plot(alpha_real_lst[51:], CDi_real_lst[51:], color='blue', linewidth=1, marker='+', markerfacecolor='none', markersize=5, markeredgecolor='blue', markeredgewidth=0.5)
plt.xlabel("$\\alpha$ [$\\deg$]", fontsize=12)
plt.ylabel("$C_{D}$ [-]", fontsize=12)
plt.grid(True)
plt.legend(fontsize=12)
