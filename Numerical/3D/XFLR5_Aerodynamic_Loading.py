...
plt.subplot(2, 2, 3)
plt.plot(alpha_lstV, CDv_lstV, color='green',linewidth=1, marker='x', markerfacecolor='none', markersize=5, markeredgecolor='green', markeredgewidth=0.5, label='$C_{D_0}$')
plt.plot(alpha_lstV, CDi_lstV, color='blue', linewidth=1, marker='+', markerfacecolor='none', markersize=5, markeredgecolor='blue', markeredgewidth=0.5,label='$C_{D_i}$')
plt.plot(alpha_lstV, CD_lstV, color='purple', linewidth=1, marker='v', markerfacecolor='none', markersize=5, markeredgecolor='purple', markeredgewidth=0.5,label='$C_{D}$')
plt.xlabel("$\\alpha$ [$\\deg$]")
plt.ylabel("$C_{D}$ [-]")
plt.grid(True)
plt.legend()
